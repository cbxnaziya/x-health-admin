...
//   {/* Brand Logo or Title on the left */}
//   <Link to="/" className="py-6 px-8 flex items-center">
//     <img src="/img/logo.png" alt="DDD Logo" className="h-8 mr-2" /> {/* Adjust the logo size */}
//     <Typography
//       variant="h6"
  ...
  return (
    ...
    >
      <div className="relative flex items-center">
        {/* Brand Logo or Title on the left */}
        <Link to="/" className="py-6 px-8 flex items-center">
          <img src="/img/logo.png" alt="DDD Logo" className="h-8 mr-2" />
          <Typography
            variant="h6"
            color={sidenavType === "dark" ? "white" : "blue-gray"}
          >
